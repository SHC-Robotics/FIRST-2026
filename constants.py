...
class FuelConstants:
    ...
    INTAKING_FEEDER_VOLTAGE = -12. * 0.1
    INTAKING_INTAKE_VOLTAGE = 8.0 * 0.1
    LAUNCHING_FEEDER_VOLTAGE = 9.0 * 0.1
    LAUNCHING_LAUNCHER_VOLTAGE = 12 * 0.1
    SPIN_UP_FEEDER_VOLTAGE = -6.0 * 0.1
    SPIN_UP_SECONDS = 1.0
